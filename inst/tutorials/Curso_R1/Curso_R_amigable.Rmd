...
:::caution
El concepto de visualización de datos no es nuevo. De hecho, la visualización de datos ha [existido durante siglos](https://jorge-leonardo-lopez-martinez.shinyapps.io/historia_visualizacion/?_ga=2.152978873.160297420.1593535028-503089247.1593365860).
:::
...
Para asociar el gráfico a un conjunto de datos en específico se emplea el argumento `data`. Luego se define un mapeo haciendo uso de la función `aes()` dentro de `ggplot()` para seleccionar las variables a graficar. Por último, con `geoms` se indica cómo se representaran los datos en el gráfico.
...
ggplot( # Primera forma
  data = pokemon,
  aes(x = ataque, y = fuerza_total, colour = tipo)
  ) +
  geom_point()
...
:::caution
<!--Colocar aqui las otras opciones de geom_-->
:::
...
<div class="row">
  <div class="col-md-6" markdown="1">
```{r ejemplo_6_2_1_1_2, exercise = TRUE, fig.align = "center", out.width='340'}

pokemon %>%
  group_by(tipo) %>%
  summarise(Total_puntos_vida = sum(puntos_vida)) %>%
  ggplot(
    data = .,
    aes(x = tipo, y = Total_puntos_vida)
    ) +
  geom_bar(stat = 'identity')
```
  </div>
  <div class="col-md-6" markdown="1">
```{r ejemplo_6_2_1_1_3, exercise = TRUE, fig.align = "center", out.width='340'}
...
<div class="row">
  <div class="col-md-6" markdown="1">
```{r ejemplo_6_2_1_1_4, exercise = TRUE, fig.align = "center", out.width='340'}
...
```
  ...
  <div class="col-md-6" markdown="1">
```{r ejemplo_6_2_1_1_5, exercise = TRUE, fig.align = "center", out.width='340'}
...
<div class="row">
  <div class="col-md-6" markdown="1">
```{r ejemplo_6_2_1_1_6, exercise = TRUE, fig.align = "center", out.width='340'}
...
```
  ...
  <div class="col-md-6" markdown="1">
```{r ejemplo_6_2_1_1_7, exercise = TRUE, fig.align = "center", out.width='340'}
...
<div class="row">
  <div class="col-md-6" markdown="1">
```{r ejemplo_6_2_1_1_8, exercise = TRUE, fig.align = "center", out.width='340'}

pokemon %>%
  inner_join(pokemon_2, 'nombre') #%>%
  #select(nombre, tipo, tipo_2) %>%
  #ggplot(
    #data = .,
    #aes(x = tipo, y = tipo_2)
    #) +
